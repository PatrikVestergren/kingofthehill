...
//    val lap1 = Lap("name1", 0, 0, 100, date)
//    val lap2 = Lap("name2", 0, 0, 100, date)
//    val lap3 = Lap("name3", 0, 0, 100, date)
//    val lap4 = Lap("name4", 0, 0, 50, date)
//    val lap5 = Lap("name5", 0, 0, 50, date)
//    val lap6 = Lap("name6", 0, 0, 50, date)
//    val lap7 = Lap("name7", 0, 0, 50, date)
//    val lap8 = Lap("name8", 0, 0, 50, date)
//    val lap9 = Lap("name9", 0, 0, 50, date)
...
//    val lap1 = Lap("name1", 0, 0, 100, date)
//    val lap2 = Lap("name2", 0, 0, 100, date)
//    val lap3 = Lap("name3", 0, 0, 102, date)
//    val lap4 = Lap("name4", 0, 0, 100, date)
//    val lap5 = Lap("name5", 0, 0, 100, date)
//    val lap6 = Lap("name6", 0, 0, 101, date)
